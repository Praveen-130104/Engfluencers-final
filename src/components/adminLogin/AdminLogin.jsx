...
const AdminLogin = () => {
    ...
    return (
        ...
        >
            ...
            <div className=" w-3/4 space-x-1 p-2 h-full py-32 flex justify-center items-center ">
                ...
                <div className="w-1/2 shadow-xl h-full border-2 bg-gradient-to-b from-slate-400 to-sky-50 rounded-2xl">
