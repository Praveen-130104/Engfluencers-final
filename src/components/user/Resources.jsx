...
const Resources = () => {
    ...
    const handleResourceFilesClick = (sub) => {
        const newFilesExpanded = !sub.filesExpanded;
        setSelectedSection(newFilesExpanded ? 'ResourceFiles' : null);

        // sub.linksExpanded = false;
        sub.filesExpanded = newFilesExpanded;

        setResourceCollections([...ResourceCollections]);
    };

    const handleResourceLinksClick = (sub) => {
        const newLinksExpanded = !sub.linksExpanded;
        setSelectedSection(newLinksExpanded ? 'ResourceLinks' : null);

        // sub.filesExpanded = false;
        sub.linksExpanded = newLinksExpanded;
            ...
            <div className="lg:container w-full h-full mx-auto">
                <div className=" py-4 h-full w-full ">
                    ...
                    <div className="w-full h-full pb-20">
                        ...
                        <div className="md:grid md:grid-cols-5 gap-2 lg:gap-6 h-full w-full overflow-hidden">
                                ...
                                {selectedRscCollection === null ?
                                    ...
                                    (
                                        <div className="flex justify-center items-center w-full h-full">
                                            ...
                                            <div className={` subcol animate__animated animate__backInDown w-full`}  >
                                                                        ...
                                                                        {subcollection.isExpanded && (
                                                                            ...
                                                                            >
                                                                                <div className="px-4 py-2 flex flex-col mx-auto bg-white w-11/12 rounded-md   justify-evenly  items-center">
                                                                                    ...
                                                                                    {
                                                                                        selectedSection === 'ResourceFiles' && subcollection.filesExpanded &&
                                                                                    ...
                                                                                    {
                                                                                        selectedSection === 'ResourceLinks' && subcollection.linksExpanded &&
                                                                                        <div className="w-full">
