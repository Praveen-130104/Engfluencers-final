...
const Blog = () => {
  ...
  return (
    ...
    <>
    {
      ...
      <div className="lg:container bg-white shadow-xl  mx-auto py-6 pb-16 " >
        <div className=" w-full  sm:py-4 items-center ">
          ...
          <div className="w-5/6  animate__animated animate__bounce  px-2 py-2 border-0 mx-auto">
            <FeaturedPosts  />
          </div>
        </div>
        ...
        <div className="p-3 mt-2  w-full mx-auto  ">
          <div className="w-full md:w-11/12 mx-auto grid grid-cols-1 lg:grid-cols-12 ">
            ...
            <div className="lg:col-span-4 col-span-1 ">
              <div className="animate__animated animate__fadeInRight relative px-6 md:px-0 md:w-9/12 lg:w-10/12 lg:mx-0 mx-auto lg:sticky top-8 md:top-28 mt-16 right-0 " >
                <PostWidget />
                <About />
              </div>
            </div>
