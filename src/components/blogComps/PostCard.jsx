  ...
  return (
    <div className="">
      <div className="flex  flex-col w-full  md:w-10/12 md:mx-auto  px-4 sm:px-0">
        ...
        <div className="md:hover:-translate-y-2 hover:shadow-none transition-all duration-500 ease-in-out bg-white w-full sm:w-10/12 lg:w-full xl:w-10/12 sm:mx-auto shadow-xl border border-gray-300 rounded-t-xl mb-14 pb-4">
          ...
          <h1 className=" ms-4 md:ms-6 underline mb-8 cursor:pointer text-blue-900 hover:text-blue-950 text-2xl md:text-3xl font-semibold">
